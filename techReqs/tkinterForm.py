...
class techReqsApp:
	def __init__(self, parent):
		...
		self.removeSelectedButton = ttk.Button(self.subFrame_frame_right_buttons, text = 'удалить пункт ТТ')
	...
	def showSymbolButtons(self, master):  # переделывать с декортаром или макетировать шаблон с заполнением из словаря
		...
		if self.checkBox_is_active.get():
			self.subFrame_symbols_buttons.grid(row = 2, column = 2, sticky = 'wens', columnspan = 3)
			self.symbolButton01 = ttk.Button(self.subFrame_symbols_buttons, width = 4, text = 'b1')
			self.symbolButton01.grid(row = 0, column = 0, sticky  = 'wens')
			self.symbolButton02 = ttk.Button(self.subFrame_symbols_buttons, width = 4, text = 'b2')
			self.symbolButton02.grid(row = 0, column = 1, sticky  = 'wens')
			self.symbolButton03 = ttk.Button(self.subFrame_symbols_buttons, width = 4, text = 'b3')
			self.symbolButton03.grid(row = 0, column = 2, sticky  = 'wens')
			self.symbolButton04 = ttk.Button(self.subFrame_symbols_buttons, width = 4, text = 'b4')
			self.symbolButton04.grid(row = 0, column = 3, sticky  = 'wens')
			self.symbolButton05 = ttk.Button(self.subFrame_symbols_buttons, width = 4, text = 'b5')
			self.symbolButton05.grid(row = 0, column = 4, sticky  = 'wens')
			self.symbolButton06 = ttk.Button(self.subFrame_symbols_buttons, width = 4, text = 'b6')
			self.symbolButton06.grid(row = 0, column = 5, sticky  = 'wens')
			self.symbolButton07 = ttk.Button(self.subFrame_symbols_buttons, width = 4, text = 'b7')
			self.symbolButton07.grid(row = 0, column = 6, sticky  = 'wens')
			self.symbolButton08 = ttk.Button(self.subFrame_symbols_buttons, width = 4, text = 'b8')
			self.symbolButton08.grid(row = 1, column = 0, sticky  = 'wens')
			self.symbolButton09 = ttk.Button(self.subFrame_symbols_buttons, width = 4, text = 'b9')
			self.symbolButton09.grid(row = 1, column = 1, sticky  = 'wens')
			self.symbolButton10 = ttk.Button(self.subFrame_symbols_buttons, width = 4, text = 'b10')
			self.symbolButton10.grid(row = 1, column = 2, sticky  = 'wens')
			self.symbolButton11 = ttk.Button(self.subFrame_symbols_buttons, width = 4, text = 'b11')
			self.symbolButton11.grid(row = 1, column = 3, sticky  = 'wens')
			self.symbolButton12 = ttk.Button(self.subFrame_symbols_buttons, width = 4, text = 'b12')
			self.symbolButton12.grid(row = 1, column = 4, sticky  = 'wens')
			self.symbolButton13 = ttk.Button(self.subFrame_symbols_buttons, width = 4, text = 'b13')
			self.symbolButton13.grid(row = 1, column = 5, sticky  = 'wens')
			self.symbolButton14 = ttk.Button(self.subFrame_symbols_buttons, width = 4, text = 'b14')
